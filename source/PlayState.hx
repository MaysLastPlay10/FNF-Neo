...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			case 'spookeez' | 'south':
			{
				...
				Boppers.scrollFactor.set(1.1, 1.1);
			...
			case 'milf' | 'satin-panties' | 'high':
			{
				...
				for (i in 0...20)
				{
					var zoom:Zoom = new Zoom(-12000, 700);
					zoom.setGraphicSize(200);
					zoom.updateHitbox();
					zoom.alpha = 0.5;
			...
			default:
			{
				...
				stageBoppers.scrollFactor.set(1.1, 1.1);
	...
	*/
	...
	//	FlxG.sound.play('assets/sounds/carPass' + FlxG.random.int(0, 1) + TitleState.soundExt, 0.7);
		...
		//bgjet.velocity.x = (FlxG.random.int(300,400) / FlxG.elapsed) * 1;
		bgjet.x = 4000;
		jet.x = bgjet.x - 700;
		jet.velocity.x = -900;
		bgjet.velocity.x = -900;
		bgjetCanDrive = false;
